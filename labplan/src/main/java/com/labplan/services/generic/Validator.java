...
/**
 * A helper class for validating user input given as a {@link String} with a
 * variety of assertions.
 * 
 * <p>
 * An instance of {@link Validator} keeps its own {@link ValidationException}.
 * Should an assertion like {@link Validator#assertNotNull(String, Object)}
 * fail, {@link Validator} uses
 * {@link ValidationException#addField(String, String)} to keep track of the
 * failed assertion.
 * 
 * <p>
 * To be able to validate multiple fields at once, {@link ValidationException}
 * is only thrown when {@link Validator#validate()} is called.
 * </p>
 * 
 * @author Elian Doran
 *
...
public class Validator {
	...
	/**
	 * Creates a new instance of {@link Validator} with the given
	 * {@code resultingObject} to be passed to {@link Validator}.
	 */
	 ...
	 * The exception is updated using
	 * {@link ValidationException#addField(String, String)} every time an assertion
	 * like {@link Validator#assertNotNull(String, Object)} fails.
	 * 
	...
	/**
	 * If any assertions have failed, the method throws the underlying
	 * {@link ValidationException}, otherwise nothing happens.
	 * 
	 * @throws ValidationException
	 *             If any assertions have failed.
	 */
	 ...
	 * 
	 * @param fieldName
	 *            The name of the field being validated, it will represent the key
	 *            of {@link ValidationException#getFields()}.
	 * @param value
	 *            The value being used for the assertion.
	...
	/**
	 * Asserts that the given {@link String} {@code value} is not {@code null} and
	...
	/**
	 * Asserts that the given {@link String} {@code value} has a length between
	 ...
	 *            The value being used for the assertion.
	 * @param minLength
	 *            The minimum length of the string, or {@code null} to skip the
	 *            minimum check.
	 * @param maxLength
	 *            The maximum length of the string, or {@code null} to skip the
	 *            maximum check.
	 * @return {@code true} if the assertion succeeded, {@code false} otherwise.
	 */
	public boolean assertStringLength(String fieldName, String value, Integer minLength, Integer maxLength) {
		if (!assertNotEmpty(fieldName, value))
			return false;
	...
	/**
	 * Asserts that the given {@link String} {@code value} contains only alphabetic
	 * characters. Whitespace is allowed if {@code permitWhitespace} is {@code true}
	 * and any character in {@code exceptions} is also allowed.
	 * 
	 * <p>
	 * The method uses {@link Character#isAlphabetic(char)} and
	 * {@link Character#isWhitespace(char)} for validation.
	 * </p>
	 * 
	 * @param fieldName
	 *            The name of the field being validated, it will represent the key
	 ...
	 * @param value
	 *            The value being used for the assertion.
	 * @param permitWhitespace
	 *            Whether to allow whitespace characters, along alphabetic
	 *            characters.
	 * @param exceptions
	 *            A string containing characters to be allowed, on top of alphabetic
	...
	/**
	 * Asserts that the given {@link String} {@code value} can be successfully
	...
	/**
	 * Asserts that the given {@link Integer} {@code value} is between
	 ...
	 *            The value being used for the assertion.
	 * @param minValue
	 *            The minimum value or {@code null} to skip the minimum check.
	 * @param maxValue
	 *            The maximum value or {@code null} to skip the maximum check.
	 * @return {@code true} if the assertion succeeded, {@code false} otherwise.
	 */
	...
	/**
	 * Asserts that the given {@link String} {@code value} is an {@link Integer}
	 * with values between is between {@code minValue} and {@code maxValue}.
	 * 
	 * @param fieldName
	 *            The name of the field being validated, it will represent the key
	 *            of {@link ValidationException#getFields()}.
	...
	public boolean assertIntegerInRange(String fieldName, String value, Integer minValue, Integer maxValue) {
		if (!assertStringIsInteger(fieldName, value))
			return false;
