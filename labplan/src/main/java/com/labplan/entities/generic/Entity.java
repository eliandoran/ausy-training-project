...
/**
 * An <i>entity</i> represents a generic object holding information that is usually obtained from/inserted into a data source.
 * The entity can be identified by a key of a generic type {@code TKey}.
 * 
