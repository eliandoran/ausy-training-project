...
public interface LabListDao extends Dao<LabList, Integer> {
	...
	/**
	 * Obtains a list of all the {@link LabList} which belong to the given {@link Patient}.
	 * @param patient	The {@link Patient} whose {@link LabList} to look for.
	 * @return	A {@link Set} containing the {@link LabList} which belong to the given {@link Patient}.
	 */
