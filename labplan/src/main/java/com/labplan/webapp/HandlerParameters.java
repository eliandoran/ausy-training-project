...
/**
 * Contains a set of object which can prove useful to a {@link ResourceHandler}.
 * Mostly it represents the current state of the {@link LabPlanServlet} such as
 * the {@link ServletContext}, {@link HttpServletResponse}, etc.
 * 
 * @author elian
 *
 */
public class HandlerParameters {
	...
	/**
	 * Creates a new instance of {@link HandlerParameters}, specifying all the
	 * contained objects at once.
	 * 
	 * @param context
	 *            The current {@link ServletContext} of the servlet.
	 * @param request
	 ...
	 * <p>
	 * Please note that the URI is being stripped of any parts after a semicolon
	 * (such as the Java session ID).
	 * </p>
	 * 
