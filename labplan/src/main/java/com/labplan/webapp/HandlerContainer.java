...
/**
 * A collection of {@link ResourceHandler} in which {@link ResourceHandler#getPath()} is used for quick retrieval.
 * @author elian
 *
 */
public class HandlerContainer {
	 ...
	 * @param handler	The {@link ResourceHandler} to add.
	 * @return			{@code true} if the {@code handler} was added, {@code false} if its path is already registered.
	 */
	 ...
	 * @param path	The path of the {@link ResourceHandler} to retrieve.
	 * @return		The {@link ResourceHandler} with the matching path, {@code null} if none found.
	 */
